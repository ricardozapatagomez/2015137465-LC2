...
namespace _2015104916.MVC.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodigoPropietario,Dni,Nombres,Apellidos,Licencia")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodigoPropietario,Dni,Nombres,Apellidos,Licencia")] Propietario propietario)
        {
            if (ModelState.IsValid)
            {
